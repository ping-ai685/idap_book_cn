...
让我们创建一个“tips”数据集中小费金额的直方图。我们假设小费的币种为美元。
...
饼图也有助于显示分类变量的比例。它们最好在类别数量*较少*时使用。类别数量较多时,饼图常常会难以阅读。
...
在本课中,我们学习了如何使用 Plotly Express 创建单变量图表。您现在应该能够独立创建条形图、饼图和直方图，并且能够修改图表的外观。
